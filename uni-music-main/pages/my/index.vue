<template>
	<div class="my-container">
		...
		<!-- #endif -->
		<div class="music-all-list hasControl" :class=" isWeixin?'isWeixinCls':'noWeixinCls'  ">
			<div class="tabs">
			...
			<scroll-view scroll-y scroll-with-animation :style="{ height: height }">
				<div class="music-item flex" :class="{ lastMusic: index == musicList.length - 1 }" 
					...
					<div class="rightInfo">
						<div class="music-info">
							<span :style="{ color: item.id == playInfo.id ? '#dd2525' : 'rgb(86,124,166)' }">{{ item.name }}</span>
